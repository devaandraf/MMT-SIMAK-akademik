...
<head>
    ...
    <link rel="icon" href="<?= base_url() ?>assets/template/images/favicon.ico">
    ...
    <!-- Style-->
    <link rel="stylesheet" href="<?= base_url() ?>assets/template/main/css/horizontal-menu.css">
            ...
            <div class="inside-header">
                <div class="d-flex align-items-center logo-box justify-content-start">
                    ...
                    <a href="index.html" class="logo">
                        <!-- logo-->
                        <div class="logo-lg">
                            <span class="light-logo"><img src="<?= base_url() ?>assets/template/images/logo-dark-text.png" alt="logo"></span>
                            <span class="dark-logo"><img src="<?= base_url() ?>assets/template/images/logo-light-text.png" alt="logo"></span>
                        </div>
                    </a>
                </div>
                <!-- Header Navbar -->
