            ...
            <div class="row">
                <div class="col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <ul class="list-group">
                                <?php foreach ($dataList_Tahsin as $key => $row): ?>
                                    <div class="item-inner">
                                        <div class="item-title-row d-flex align-items-center">
                                            <!-- <div class="item-title flex-grow-1"><h5><?php echo $row["nama"]; ?></h5></div> -->
                                            <div class="item-title flex-grow-1"><h5><h5><?php echo $row["nama"]; ?> membaca surat <?php echo $row["nama_surat"]; ?> (<?php echo $row["ayat_akhir"] - $row["ayat_awal"]; ?> Ayat)</h5></div>
    ...
    <div class="chat-box">
        <div class="chat-box-header p-15 d-flex justify-content-between align-items-center">
            <div class="text-center flex-grow-1">
                <div class="text-dark font-size-18 m-10"><b>Penilaian Tahsin</b></div>
                <div>
        ...
        <form action="<?= base_url("penilaian/tahsin/tambah")?>" method = "POST" id="inputTahsin">
        <div class="chat-box-body">
            <div class="chat-box-overlay">
            </div>
                <div class="chat-logs" id="modalInputTahsin">
